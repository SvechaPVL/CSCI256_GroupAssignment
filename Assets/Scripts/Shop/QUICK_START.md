# ⚡ Quick Start - Полная настройка магазина за 1 МИНУТУ!

## 🎯 Ваша рабочая сцена: **Assets/Forest.unity**

---

## 🚀 СУПЕРНОВАЯ ФУНКЦИЯ - Создание ВСЕГО одной кнопкой!

### ✨ ONE-CLICK SETUP (30 секунд!)

1. Откройте сцену **Forest.unity**
2. Unity меню: **Tools → Shop System → Create Shop UI**
3. Нажмите БОЛЬШУЮ ЗЕЛЁНУЮ кнопку: **🚀 CREATE COMPLETE SHOP SYSTEM 🚀**
4. **Готово!** Всё создано автоматически!

**Что создалось:**
- ✅ Canvas с ShopPanel, PromptPanel, DetailPanel
- ✅ Item Card Prefab
- ✅ ShopManager (со всеми ссылками!)
- ✅ ShopTrigger (зелёный полупрозрачный куб)
- ✅ Все ссылки между компонентами автоматически назначены

**Осталось только:**
1. Добавить **AutoSetupPlayer** на игрока (если ещё не добавили)
2. Создать предметы: Tools → Shop System → Create Shop Items → "CREATE ALL ITEMS"
3. Назначить созданные предметы в **ShopManager → Available Items**
4. Переместить **ShopTrigger** куда нужно в сцене
5. **Запустить игру!**

---

## ⚡ Или по отдельным шагам (если хотите контроль):
