...
### 🎨 Добавить текстуры и звуки:
- **См. [STYLING_GUIDE.md](STYLING_GUIDE.md)** - полный гайд по стилизации!
- Иконки для предметов
- Красивые UI текстуры
- Звуковые эффекты
- Бесплатные Asset Store паки
- Стилизация за 15 минут
